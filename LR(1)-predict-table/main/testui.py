...
class MainFrame(Tkinter.Frame):
    def __init__(self, root):
        ...
        self.root = root
        Tkinter.Label(root,text="编译原理LR(1）语法分析教学辅助实验系统",font =("Times", "24", "bold italic")).pack()
    ...
    def update_product_text(self):
        ...
        if self.product_filename:
            self.product_file_label.config(text='...'+self.product_filename[-50:])
    ...
    def parsing_table(self):
        ...
        text = Tkinter.Text(top,font =("Times", "12", "italic"))
